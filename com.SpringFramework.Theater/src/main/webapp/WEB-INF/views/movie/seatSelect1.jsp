...
<body>
        <fieldset class="seatform">
            ...
            <br>
            E
            <input type="button" class="seats" value="E1" id="E1" onclick="selectseat('E1')"/>
            <input type="button" class="seats" value="E2" id="E2" onclick="selectseat('E2')"/>
            <input type="button" class="seats" value="E3" id="E3" onclick="selectseat('E3')"/>
            <input type="button" class="seats" value="E4" id="E4" onclick="selectseat('E4')"/>
            <input type="button" class="seats" value="E5" id="E5" onclick="selectseat('E5')"/>
            <input type="button" class="seats" value="E6" id="E6" onclick="selectseat('E6')"/>
            <input type="button" class="seats" value="E7" id="E7" onclick="selectseat('E7')"/>
            <input type="button" class="seats" value="E8" id="E8" onclick="selectseat('E8')"/>
            <input type="button" class="seats" value="E9" id="E9" onclick="selectseat('E9')"/>
            <br>
            F
            <input type="button" class="seats" value="F1" id="F1" onclick="selectseat('F1')"/>
            <input type="button" class="seats" value="F2" id="F2" onclick="selectseat('F2')"/>
            <input type="button" class="seats" value="F3" id="F3" onclick="selectseat('F3')"/>
            <input type="button" class="seats" value="F4" id="F4" onclick="selectseat('F4')"/>
            <input type="button" class="seats" value="F5" id="F5" onclick="selectseat('F5')"/>
            <input type="button" class="seats" value="F6" id="F6" onclick="selectseat('F6')"/>
            <input type="button" class="seats" value="F7" id="F7" onclick="selectseat('F7')"/>
            <input type="button" class="seats" value="F8" id="F8" onclick="selectseat('F8')"/>
            <input type="button" class="seats" value="F9" id="F9" onclick="selectseat('F9')"/>
        </fieldset>
