<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR"%>
   <%@ page import="java.util.*,com.example.sba.domain.UserInfo" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="EUC-KR">
...
<body>
	<p><a href="ex1.jsp">[이전]</a><a href="ex3.jsp">[다음]</a>
	<h2>EL - 값 꺼내기</h2>
	<% 
		...
		pageContext.setAttribute("userinfo",new UserInfo().setId("abc").setPw("123").setName("홍길동"));
	%>
	<table>
	...
	<tr>
		...
		<td>리스트에서 인덱스로 지정된 항목의 값을 꺼낸다.<br>
		<pre>[자바코드]
		List<String> nameList = new LinkedList<String>();
		nameList.add("홍길동");
		nameList.add("홍길동");
